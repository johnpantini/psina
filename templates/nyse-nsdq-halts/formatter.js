...
const mappings = {
  ...
  MWC1: 'Пауза из-за срабатывания глобальной стоп-защиты рынка',
  MWC2: 'Пауза из-за срабатывания глобальной стоп-защиты рынка',
  MWC3: 'Пауза из-за срабатывания глобальной стоп-защиты рынка',
  MWC0: 'Пауза из-за срабатывания глобальной стоп-защиты рынка',
  ...
  R1: 'См. код T1',
  R2: 'См. код T2',
  IPOQ: 'Начало котирования в день IPO',
  IPOE: 'Расширение периода подачи заявок в перекрёстной сессии NASDAQ для инструментов в день IPO',
